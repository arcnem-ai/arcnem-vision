...
LIVE_SERVICE_S3_PUBLIC_BASE_URL := http://localhost:$(LIVE_SERVICE_MINIO_API_HOST_PORT)/$(LIVE_SERVICE_S3_BUCKET)
...
LIVE_SERVICE_API_DOCKER_ARGS := --env BETTER_AUTH_BASE_URL=$(LIVE_SERVICE_API_BASE_URL_CONTAINER) --env DATABASE_URL=$(LIVE_SERVICE_DB_URL_CONTAINER) --env REDIS_URL=$(LIVE_SERVICE_REDIS_URL_CONTAINER) --env S3_ENDPOINT=$(LIVE_SERVICE_S3_ENDPOINT_CONTAINER) --env S3_PUBLIC_BASE_URL=$(LIVE_SERVICE_S3_PUBLIC_BASE_URL) --env MCP_SERVER_URL=$(LIVE_SERVICE_MCP_SERVER_URL_CONTAINER) --env INNGEST_DEV=$(LIVE_SERVICE_INNGEST_BASE_URL_CONTAINER)
...
live-service-test: live-service-stack-up
	...
	$(DOCKER) run --rm \
		...
		--env S3_PUBLIC_BASE_URL='$(LIVE_SERVICE_S3_PUBLIC_BASE_URL)' \
		$(LOCAL_DOCKER_ARGS) \
		oven/bun:1.3.11 \
