...
DASHBOARD_BUILD_ARG_VARS := API_URL
DASHBOARD_PORT := 3001
...
LIVE_SERVICE_DB_URL_CONTAINER := postgres://postgres:postgres@postgres:5432/postgres
LIVE_SERVICE_REDIS_URL_CONTAINER := redis://redis:6379
LIVE_SERVICE_S3_ENDPOINT_CONTAINER := http://minio:9000
...
LIVE_SERVICE_S3_PUBLIC_BASE_URL_CONTAINER := http://minio:9000/$(LIVE_SERVICE_S3_BUCKET)
...
LIVE_SERVICE_API_BASE_URL_CONTAINER := http://$(LIVE_SERVICE_API_CONTAINER):$(API_CONTAINER_PORT)
...
LIVE_SERVICE_NETWORK_ARGS := --network $(LIVE_SERVICE_STACK_NAME)_default
...
LIVE_SERVICE_DB_DOCKER_ARGS := $(LIVE_SERVICE_NETWORK_ARGS) --env DATABASE_URL=$(LIVE_SERVICE_DB_URL_CONTAINER) --env S3_ENDPOINT=$(LIVE_SERVICE_S3_ENDPOINT_CONTAINER)
LIVE_SERVICE_API_DOCKER_ARGS := $(LIVE_SERVICE_NETWORK_ARGS) --env BETTER_AUTH_BASE_URL=$(LIVE_SERVICE_API_BASE_URL_HOST) --env INNGEST_SERVE_ORIGIN=$(LIVE_SERVICE_API_BASE_URL_CONTAINER) --env DATABASE_URL=$(LIVE_SERVICE_DB_URL_CONTAINER) --env REDIS_URL=$(LIVE_SERVICE_REDIS_URL_CONTAINER) --env S3_ENDPOINT=$(LIVE_SERVICE_S3_ENDPOINT_CONTAINER) --env S3_PUBLIC_BASE_URL=$(LIVE_SERVICE_S3_PUBLIC_BASE_URL_CONTAINER) --env S3_USE_PATH_STYLE=true --env MCP_SERVER_URL=$(LIVE_SERVICE_MCP_SERVER_URL_CONTAINER) --env INNGEST_DEV=$(LIVE_SERVICE_INNGEST_BASE_URL_CONTAINER)
LIVE_SERVICE_AGENTS_DOCKER_ARGS := $(LIVE_SERVICE_NETWORK_ARGS) --env DATABASE_URL=$(LIVE_SERVICE_DB_URL_CONTAINER) --env REDIS_URL=$(LIVE_SERVICE_REDIS_URL_CONTAINER) --env S3_ENDPOINT=$(LIVE_SERVICE_S3_ENDPOINT_CONTAINER) --env MCP_SERVER_URL=$(LIVE_SERVICE_MCP_SERVER_URL_CONTAINER) --env INNGEST_DEV=$(LIVE_SERVICE_INNGEST_BASE_URL_CONTAINER)
LIVE_SERVICE_MCP_DOCKER_ARGS := $(LIVE_SERVICE_NETWORK_ARGS) --env DATABASE_URL=$(LIVE_SERVICE_DB_URL_CONTAINER) --env REDIS_URL=$(LIVE_SERVICE_REDIS_URL_CONTAINER) --env S3_ENDPOINT=$(LIVE_SERVICE_S3_ENDPOINT_CONTAINER)
