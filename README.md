...
You'll need:
- **Hosted S3-compatible bucket** — endpoint, bucket, and credentials in `server/packages/api/.env` and `models/agents/.env` (for example AWS S3, Cloudflare R2, Railway Object Storage, Backblaze B2)
