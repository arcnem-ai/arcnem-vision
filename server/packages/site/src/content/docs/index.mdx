...
<CardGrid stagger>
  ...
  <Card title="Agents through OAuth MCP" icon="setting">
    Connect an external agent to inspect and edit graphs, run experiments, and read the results. See the <a href="/guides/oauth-mcp/">OAuth MCP guide</a>.
  </Card>
</CardGrid>
