...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Banned = field.NewBool(tableName, "banned")
	_user.BanReason = field.NewString(tableName, "ban_reason")
	_user.BanExpires = field.NewTime(tableName, "ban_expires")
...
func (u *user) updateTableName(table string) *user {
	...
	u.Banned = field.NewBool(table, "banned")
	u.BanReason = field.NewString(table, "ban_reason")
	u.BanExpires = field.NewTime(table, "ban_expires")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["banned"] = u.Banned
	u.fieldMap["ban_reason"] = u.BanReason
	u.fieldMap["ban_expires"] = u.BanExpires
}
